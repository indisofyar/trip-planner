<template>
  <div :class="{ 'stop-moving': ($store.state.selectedPopup != null) }">
    <header aria-label="Site Header" class="shadow-sm bg-blue-950">
      <div class="mx-auto max-w-screen-xl p-4">
        <div class="flex items-center justify-between gap-4 lg:gap-10">
          ...
          <nav aria-label="Site Nav" class="hidden gap-8 text-sm font-medium md:flex">
            ...
            <RouterLink to="/" class="text-white">Get started</RouterLink>
          </nav>
          <div class="hidden flex-1 items-center justify-end gap-4 sm:flex">
            <button class="rounded-lg bg-gray-100 px-5 py-2 text-sm font-medium text-blue-600" >
              Log in
            </button>
          ...
          <div class="lg:hidden">
            <button class="rounded-lg bg-gray-100 p-2 text-gray-600" type="button " @click="openMenu = !openMenu">
      ...
      <nav v-if="openMenu" class="bg-white w-full h-full fixed z-10 py-3 px-2">
        <div class="mb-2"><RouterLink to="/" class="text-2xl font-medium " @click="openMenu = false">Home</RouterLink></div>
        <RouterLink to="/get-started" class="text-2xl font-medium" @click="openMenu = false">Get started</RouterLink>
